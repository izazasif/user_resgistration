...
<body>
    ...
    <table style="margin-top:-140px;">
        <tr>
            ...
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;text-align: justify;">{{ $profile->full_name }}</th>
        </tr>
        <tr>
            ...
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;width:540px;text-align: justify;">{{ $profile->goals }} </th>
        </tr>
        <tr>
            <th style="text-align: left;padding-left: 20px;font-size: 15px;width:80px;font-weight: bold;margin: 6;color:#990000;">Height:</th>
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;width:80px;text-align: justify;">{{ $profile->height }}</th>
        </tr>
        <tr>
            <th style="text-align: left;padding-left: 20px;font-size: 15px;width:80px;font-weight: bold;margin: 6;color:#990000;">Weight:</th>
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;width:80px;text-align: justify;">{{ $profile->weight }}</th>
        </tr>
        <tr>
            <th style="text-align: left;padding-left: 20px;font-size: 15px;width:80px;font-weight: bold;margin: 6;color:#990000;">DOB:</th>
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;width:80px;text-align: justify;">{{ Carbon\Carbon::parse($profile->dob)->format('j- M-Y') }}</th>
        </tr>
        <tr>
            <th style="text-align: left;padding-left: 20px;font-size: 15px;width:80px;font-weight: bold;margin: 6;color:#990000;">Address:</th>
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;width:80px;text-align: justify;">{{ $profile->address }}</th>
        </tr>
        <tr>
            <th style="text-align: left;padding-left: 20px;font-size: 15px;width:80px;font-weight: bold;margin: 6;color:#990000;">Email:</th>
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;width:80px;text-align: justify;text-decoration: underline;">{{ $profile->email }}</th>
            <!-- <p style="border-bottom: 2px solid black;margin-left:-690px;width:100px;margin-top:40px;"></p> -->
        </tr>
        <tr>
            <th style="text-align: left;padding-left: 20px;font-size: 15px;width:80px;font-weight: bold;margin: 6;color:#990000;">Phone:</th>
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;width:80px;text-align: justify;">{{ $profile->phone_number }}</th>
        </tr>
        <tr>
            ...
            <th style="padding-left: 100px;font-size: 16px;font-weight: normal;width:80px;text-align: justify;">{!! str_replace(',', '<br>', $profile->parents) !!}</th>
        </tr>
        </table>
        <table>
            <tr>
                ...
                <th >   
                    <table>
                        ...
                        <tr>
                            ...
                            <th style="padding-left: 0px;font-size: 16px;width:70px;text-align: left;vertical-align: top;font-weight: normal;">{{ $profile->c_achievements  }}</th>
                        </tr>
